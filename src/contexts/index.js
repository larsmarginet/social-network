...
const thread1 = new Thread({administrator: user3, id: 'aaa001', question: "Once again I am asking for your financial support. 💰💵🤑", keywords: ["money", "campaign", "not me. Us"], users: [user1, user2], store: dataStore});
thread1.comments = [
...
const thread2 = new Thread({administrator: user4, id: 'aaa002', question: "Truth over facts!", keywords: ["democrat", "You know the thing", "Biden"], users: [user1, user2], store: dataStore})
thread2.comments = [
